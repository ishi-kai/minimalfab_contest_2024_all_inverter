...
C {PMOS_MIN.sym} 80 -100 0 0 {name=M1 model=pch w=40u l=10u as=0 ps=0 ad=0 pd=0 m=1}
C {NMOS_MIN.sym} 80 0 0 0 {name=M2 model=nch w=20u l=10u as=0 ps=0 ad=0 pd=0 m=1}
