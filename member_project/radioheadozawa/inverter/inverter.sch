...
C {NMOS_MIN.sym} 30 40 0 0 {name=M1 model=nch w=5u l=0.18u as=0 ps=0 ad=0 pd=0 m=1}
C {PMOS_MIN.sym} 30 -50 0 0 {name=M2 model=pch w=5u l=0.18u as=0 ps=0 ad=0 pd=0 m=1}
