...
N 40 -0 40 70 {lab=Q}
N 40 130 40 170 {lab=xxx}
N 40 100 70 100 {lab=xxx}
N 70 100 70 140 {lab=xxx}
N 40 140 70 140 {lab=xxx}
N -30 100 0 100 {lab=A}
N -30 -30 -30 100 {lab=A}
N -30 -30 0 -30 {lab=A}
N 40 40 210 40 {lab=Q}
N -120 40 -30 40 {lab=A}
C {.xschem/symbols/MF20/PMOS_MIN.sym} 0 -30 0 0 {name=M1 model=pch w=5u l=0.18u as=0 ps=0 ad=0 pd=0 m=1}
C {.xschem/symbols/MF20/NMOS_MIN.sym} 0 100 0 0 {name=M2 model=nch w=5u l=0.18u as=0 ps=0 ad=0 pd=0 m=1}
C {devices/iopin.sym} -180 -310 0 0 {name=p1 lab=xxx}
