...
C {.xschem/symbols/MF20/PMOS_MIN.sym} 0 -30 0 0 {name=M1 model=pmos w=20u l=6u as=0 ps=0 ad=0 pd=0 m=1}
C {.xschem/symbols/MF20/NMOS_MIN.sym} 0 100 0 0 {name=M2 model=nmos w=20u l=10u as=0 ps=0 ad=0 pd=0 m=1}
